...
--input_dir /data/shot2story/videos/release_134k_videos/ --frame_fps 2 --max_num_frames 400 \
...
> ${output_dir}/eval/magqa_test-thres_${thres}-rm_ass_turn-pred.log 
wait
...
--llm_pretrained http:meta-llama/Llama-3.3-70B-Instruct \
...
> ${output_dir}/eval/magqa_test-thres_${thres}-rm_ass_turn-llama_score-eval.log 
wait
...
python test/openai_batch.py --func send_batch \
    ...
    --description "magqa test set evaluate"         # you can change to other descriptions for this task
